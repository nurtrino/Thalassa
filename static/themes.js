...
const THEMES = {
  ...
  autumn: {
    ...
    // the Vale is a fog-of-war maze: thick amber murk swallows the middle
    // distance — the flat golden trail arrows, landing beacons and barrow
    // beam are all fog-free, so the WAY always reads even when the woods
    // beyond it don't
    fog: { color: 0xe3b184, near: 20, far: 170 },
