...
Five interactive/generated kinds (client never receives fields in "secret"):
  ...
  · nonogram   5×5 picross: paint cells to satisfy row/column clues. Any
               grid matching the clues counts.
...
TIME_LIMITS = {"riddle": 60, "tetromino": 100, "nonogram": 120,
...
def gen_nonogram(rng: random.Random, n: int = 5) -> dict:
    ...
    return {"n": n, "rows": rows, "cols": cols, "secret": {}}
