...
TIME_LIMITS = {"riddle": 27.5, "tetromino": 97.5, "nonogram": 59.375,
...
def gen_visual_memory(rng: random.Random, n: int = 7, lit: int = 6) -> dict:
    """A 7×7 board briefly flashes `lit` tiles; memorise them, then click them
    ...
    verifies the picks match it. One clean round wins the trial."""
...
BATTLE_TIERS = {
    ...
    # (simon) or click back the flashed tiles (visual_memory); else the Gorgon's
    # Gaze or a riddle
    1: ("simon", "visual_memory", "lights_out", "riddle"),
